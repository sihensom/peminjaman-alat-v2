<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-xl font-black text-foreground tracking-tight">Edit Alat</h2>
                <p class="text-xs text-muted-foreground font-medium">Ubah spesifikasi perangkat di sistem</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="card-premium overflow-hidden bg-gradient-to-b from-card to-muted/20">
            ...
            <form method="POST" action="{{ route('alats.update', $alat) }}" class="p-8 space-y-10">
                @csrf
                @method('PUT')
                        ...
                        <div class="md:col-span-2 group">
                            ...
                            <div class="relative">
                                ...
                                <input id="nama_alat" name="nama_alat" type="text" 
                                    ...
                                    value="{{ old('nama_alat', $alat->nama_alat) }}" required autofocus />
                            </div>
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                ...
                                <input id="stok" name="stok" type="number" 
                                    ...
                                    value="{{ old('stok', $alat->stok) }}" required min="0" />
                            </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            @foreach(['baik', 'rusak ringan', 'rusak berat'] as $val)
                                <label class="relative cursor-pointer group/label">
                                    <input type="radio" name="kondisi" value="{{ $val }}" class="peer sr-only" {{ old('kondisi', $alat->kondisi) == $val ? 'checked' : '' }}>
